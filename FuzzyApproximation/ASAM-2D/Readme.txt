...
Version (2.0): Trains 6 SAMs to approximate a user-specified 2-dimensional function using samples of the objective function.
...
3) There is a make file for running the code. Just type "make ASAM2D" on the CMD terminal. Use "make clean" to delete all the output files. 
